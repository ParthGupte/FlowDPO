from datamodule.oxford_pets_loader import FlowOxfordPetCatsDataModule
import lightning as L
import torch
from diffusers import UNet2DModel
from experiments.configs import training_config_4 as training_config
from lightning.pytorch.loggers import WandbLogger
from models.unet_flow import FlowModelCats
from lightning.pytorch.callbacks import ModelCheckpoint
import sys
from seed_all import set_seed
from experiments.configs import model_config_4 as model_config
...
data_module = FlowOxfordPetCatsDataModule(
...
checkpoint_callback_avg_loss = ModelCheckpoint(
    ...
    filename="FlowModel_cats-{epoch:02d}-{train_epoch_avg_loss:.4f}",
...
checkpoint_callback_FID = ModelCheckpoint(
    ...
    filename="FlowModel_cats-{epoch:02d}-{FID:.4f}",
    save_weights_only=False,
...
unet = UNet2DModel(
    sample_size = training_config.IMAGE_SHAPE,
...
flowmodel = FlowModelCats(unet,model_config,training_config)
